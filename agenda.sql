...
--
-- Name: agendapp_contato; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE agendapp_contato (
    id integer NOT NULL,
    nome character varying(200) NOT NULL,
    telefone1 character varying(20) NOT NULL,
    telefone2 character varying(20) NOT NULL,
...
ALTER TABLE agendapp_contato OWNER TO postgres;

--
-- Name: agendapp_contato_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE agendapp_contato_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE agendapp_contato_id_seq OWNER TO postgres;

--
-- Name: agendapp_contato_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE agendapp_contato_id_seq OWNED BY agendapp_contato.id;
...
ALTER TABLE ONLY agendapp_contato ALTER COLUMN id SET DEFAULT nextval('agendapp_contato_id_seq'::regclass);
...
--
-- Data for Name: agendapp_contato; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY agendapp_contato (id, nome, telefone1, telefone2, email, endereco, dtnasc, obs) FROM stdin;
\.


--
-- Name: agendapp_contato_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('agendapp_contato_id_seq', 7, true);
...
1	contenttypes	0001_initial	2016-06-13 15:21:56.514465-03
2	auth	0001_initial	2016-06-13 15:21:57.46604-03
3	admin	0001_initial	2016-06-13 15:21:57.674169-03
4	admin	0002_logentry_remove_auto_add	2016-06-13 15:21:57.715501-03
5	agendapp	0001_initial	2016-06-13 15:21:57.815902-03
6	contenttypes	0002_remove_content_type_name	2016-06-13 15:21:57.882245-03
7	auth	0002_alter_permission_name_max_length	2016-06-13 15:21:57.915616-03
8	auth	0003_alter_user_email_max_length	2016-06-13 15:21:57.948858-03
9	auth	0004_alter_user_username_opts	2016-06-13 15:21:57.973042-03
10	auth	0005_alter_user_last_login_null	2016-06-13 15:21:57.998875-03
11	auth	0006_require_contenttypes_0002	2016-06-13 15:21:58.007208-03
12	auth	0007_alter_validators_add_error_messages	2016-06-13 15:21:58.031636-03
13	sessions	0001_initial	2016-06-13 15:21:58.22424-03
\.
...
--
-- Name: agendapp_contato_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY agendapp_contato
    ADD CONSTRAINT agendapp_contato_pkey PRIMARY KEY (id);
